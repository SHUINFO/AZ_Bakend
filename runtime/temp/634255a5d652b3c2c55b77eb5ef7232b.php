<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"/data/wwwroot/az-ips.wxhoutai.com/public/../application/admin/view/cms/archives/edit.html";i:1598363247;s:76:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/layout/default.html";i:1598331185;s:73:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/meta.html";i:1598331185;s:75:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/script.html";i:1598331185;}*/ ?>
<!DOCTYPE html>
                    ...
                    <div id="myTabContent" class="tab-content">
                        <div class="tab-pane fade active in" id="basic">
                            ...
                            <div class="form-group hidden">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <input id="c-tags" data-rule="" class="form-control" placeholder="输入后空格确认" name="row[tags]" type="text" value="<?php echo htmlentities($row['tags']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-8">
                                    <textarea id="c-content" data-rule="" class="form-control editor" name="row[content]" rows="15"><?php echo htmlentities($row['content']); ?></textarea>
                                </div>
                            </div>
                            <div id="extend"></div>
                        </div>
