<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/data/wwwroot/az-ips.wxhoutai.com/public/../application/admin/view/cms/block/add.html";i:1597470219;s:76:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/layout/default.html";i:1588765312;s:73:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/meta.html";i:1588765312;s:75:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-type" data-rule="required" class="form-control selectpage" data-source="cms/block/selectpage_type" placeholder="类型为自定义,可任意输入,输入后请点击选择" data-primary-key="type" data-field="type" name="row[type]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8">
            <div class='input-group date datetimepicker'>
                <input type='text' name="row[begintime]" data-rule="" data-date-format="YYYY-MM-DD HH:mm:ss" value="" placeholder="可以留空" class="form-control datetimepicker"/>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8">
            <div class='input-group date datetimepicker'>
                <input type='text' name="row[endtime]" data-rule="" data-date-format="YYYY-MM-DD HH:mm:ss" value="" placeholder="可以留空" class="form-control datetimepicker"/>
                <span class="input-group-addon">
                    <span class="fa fa-calendar"></span>
                </span>
            </div>
