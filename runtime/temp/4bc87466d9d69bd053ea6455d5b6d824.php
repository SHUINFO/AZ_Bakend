<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/data/wwwroot/az-ips.wxhoutai.com/public/../application/admin/view/doctor/add.html";i:1602498286;s:76:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/layout/default.html";i:1598331185;s:73:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/meta.html";i:1598331185;s:75:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/script.html";i:1598331185;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="wxid" name="row[wxid]" value="" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="hospital_id" data-source="hospital/index" class="form-control selectpage" name="row[hospital_id]" type="text" value="">
        </div>
    </div>


    <div class="form-group">
        <label for="content" class="control-label col-xs-12 col-sm-2"><?php echo __('deparment'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select class="form-control selectpicker" data-source="hospital/department" id="department" name="row[department]"></select>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="position" name="row[position]" value="" />
        </div>
    </div>
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="radio" name="row[category]" value="category1" id="type-text" checked />
            <label for="type-text"><?php echo __('category1'); ?></label>
            <input type="radio" name="row[category]" value="category2" id="type-app" />
            <label for="type-app"><?php echo __('category2'); ?></label>
        </div>
    </div> -->
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-wxgroup_qr" data-rule="" class="form-control" size="50" name="row[wxgroup_qr]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
