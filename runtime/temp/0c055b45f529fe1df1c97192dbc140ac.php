<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:87:"/data/wwwroot/az-ips.wxhoutai.com/public/../application/admin/view/cms/fields/edit.html";i:1598363247;s:76:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/layout/default.html";i:1598331185;s:73:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/meta.html";i:1598331185;s:75:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/script.html";i:1598331185;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <input type="hidden" name="row[model_id]" value="<?php echo $row['model_id']; ?>"/>
    <input type="hidden" name="row[diyform_id]" value="<?php echo $row['diyform_id']; ?>"/>
    ...
    <div class="form-group hidden tf tf-select tf-selects tf-checkbox tf-radio tf-array">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-content" data-rule="required" class="form-control" name="row[content]"><?php echo $row['content']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-defaultvalue" class="control-label col-xs-12 col-sm-2"><?php echo __('Defaultvalue'); ?>:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-defaultvalue" class="form-control" name="row[defaultvalue]" type="text" value="<?php echo $row['defaultvalue']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-msg" class="form-control" name="row[msg]" type="text" value="<?php echo $row['msg']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-ok" class="control-label col-xs-12 col-sm-2"><?php echo __('Validate Ok'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-ok" class="form-control" name="row[ok]" type="text" value="<?php echo $row['ok']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-tip" class="control-label col-xs-12 col-sm-2"><?php echo __('Validate Tip'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-tip" class="form-control" name="row[tip]" type="text" value="<?php echo $row['tip']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-extend" class="form-control" name="row[extend]"><?php echo $row['extend']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
