<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"/data/wwwroot/az-ips.wxhoutai.com/public/../application/admin/view/patient/edit.html";i:1602498286;s:76:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/layout/default.html";i:1598331185;s:73:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/meta.html";i:1598331185;s:75:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/script.html";i:1598331185;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="doctor_id" data-source="doctor/index" class="form-control selectpage" name="row[doctor_id]" type="text" value="<?php echo $row['doctor_id']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="age" name="row[birth_year]" value="<?php echo $row['birth_year']; ?>" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="disease" name="row[disease]" value="<?php echo $row['disease']; ?>" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="diagnose_at" name="row[diagnose_at]" value="<?php echo $row['diagnose_at']; ?>" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[medicine]', ['1' => __('M1'), '2' => __('M2')], $row['medicine']); ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea name="row[address]" class="form-control"  rows="3"><?php echo $row['address']; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="smoke" name="row[smoke]" value="<?php echo $row['smoke']; ?>" />
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea name="row[memo]" class="form-control"  rows="10"><?php echo $row['memo']; ?></textarea>
        </div>
    </div>
