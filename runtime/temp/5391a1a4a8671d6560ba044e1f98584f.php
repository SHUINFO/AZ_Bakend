<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:85:"/data/wwwroot/az-ips.wxhoutai.com/public/../application/admin/view/cms/page/edit.html";i:1597470219;s:76:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/layout/default.html";i:1588765312;s:73:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/meta.html";i:1588765312;s:75:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-type" data-rule="required" class="form-control selectpage" data-source="cms/page/selectpage_type" data-primary-key="type" data-field="type" name="row[type]" type="text" value="<?php echo $row['type']; ?>">
        </div>
    </div>
    <div class="form-group">
