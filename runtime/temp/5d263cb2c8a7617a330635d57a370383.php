<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"/data/wwwroot/az-ips.wxhoutai.com/public/../application/admin/view/cms/modelx/add.html";i:1597470219;s:76:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/layout/default.html";i:1588765312;s:73:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/meta.html";i:1588765312;s:75:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/script.html";i:1588765312;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-table" data-rule="required" class="form-control" name="row[table]" placeholder="建议以 cms_addonxxx 格式命名" type="text">
        </div>
    </div>
    <div class="form-group">
        <label for="c-channeltpl" class="control-label col-xs-12 col-sm-2"><?php echo __('Channeltpl'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-channeltpl" data-rule="" class="form-control selectpage" name="row[channeltpl]" data-source="cms/ajax/get_template_list" data-params='{"type":"channel"}' data-primary-key="name" data-field="name" type="text" value="" placeholder="自定义模板文件必须以channel开头">
        </div>
    </div>
    <div class="form-group">
