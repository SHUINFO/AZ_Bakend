<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"/data/wwwroot/az-ips.wxhoutai.com/public/../application/admin/view/cms/archives/index.html";i:1598363247;s:76:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/layout/default.html";i:1598331185;s:73:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/meta.html";i:1598331185;s:75:"/data/wwwroot/az-ips.wxhoutai.com/application/admin/view/common/script.html";i:1598331185;}*/ ?>
<!DOCTYPE html>
                        ...
                        <div id="toolbar" class="toolbar">
                            ...
                            <div class="dropdown btn-group <?php echo $auth->check('cms/archives/multi')?'':'hide'; ?>">
                                ...
                                <ul class="dropdown-menu text-left" role="menu">
                                    <li><a class="btn btn-link btn-setspecial btn-disabled disabled" href="javascript:;"><i class="fa fa-newspaper-o"></i> <?php echo __('Set special'); ?></a></li>
